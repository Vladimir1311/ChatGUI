...
public class Server 
{
    ...
    public Server(int port)
    {
        ...
        serverRun = new Thread(new Runnable()
        {
            ...
            {
                running = true;
                System.out.println("Стартовый порт сервера " + port);
                manage();
                receive();
            }
        }, "serverRun");
        ...
        receive = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                while(running)
                {
                    ...
                    process(packet);
                    clients.add(new ServerClient("Vladimir", 
                            packet.getAddress(), packet.getPort(), 3434));
    ...
    private void process(DatagramPacket packet)
    {
        ...
        if(str.startsWith("/c"))
        {
            ...
            clients.add(new ServerClient(str.substring(3, str.length()), 
